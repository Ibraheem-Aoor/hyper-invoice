...
<a href="#" class="btn btn-sm btn-primary btn-icon rounded-pill cp_link" data-link="{{route('pay.proposalpay',\Illuminate\Support\Facades\Crypt::encrypt($proposal->id))}}" data-toggle="tooltip" data-original-title="{{__('Click to copy invoice link')}}">
