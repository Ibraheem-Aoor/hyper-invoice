                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col text-md-right">
                                    <small>
                                        ...
                                        {{utility::dateFormat($company_setting,$proposal->issue_date)}}<br><br>
                                    </small>
                                </div>
                                <div class="col text-md-right">
                                    ...
                                    <div class="table-responsive mt-2">
                                        <table class="table mb-0 table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">{{utility::priceFormat($company_setting,$proposal->getSubTotal())}}</td>
                                            </tr>
                                            @if($proposal->discount_apply==1)
                                                <tr>
                                                    <td colspan="6"></td>
                                                    <td class="text-right"><b>{{__('Discount')}}</b></td>
                                                    <td class="text-right">{{utility::priceFormat($company_setting,$proposal->getTotalDiscount())}}</td>
                                                </tr>
                                            @endif
                                            @if(!empty($taxesData))
                                            ...
                                            <tr>
                                                ...
                                                <td class="blue-text text-right">{{utility::priceFormat($company_setting,$proposal->getTotal())}}</td>
                                            </tr>
                                            </tfoot>
                                        </table>
                                    </div>
