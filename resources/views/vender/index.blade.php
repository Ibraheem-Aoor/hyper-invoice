    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('create vender')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-size="2xl" data-url="{{ route('vender.create') }}" data-ajax-popup="true"
        ...
        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
            <div class="all-button-box">
                <a href="#" class="btn btn-xs btn-white btn-icon-only width-auto"
                    data-url="{{ route('vender.file.import') }}" data-ajax-popup="true"
                                                ...
                                                @else
                                                    ...
                                                    @can('edit vender')
                                                        <a href="#" class="edit-icon" data-size="2xl"
                                                            ...
                                                            data-ajax-popup="true" data-title="{{ __('Edit Vendor') }}"
