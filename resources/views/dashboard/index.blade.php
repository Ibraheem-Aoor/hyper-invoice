                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-6">
                                    <div class="p-4">
                                        ...
                                        <h5 class="report-text mb-0">{{number_format($goal->target($goal->type,$goal->from,$goal->to,$goal->amount)['percentage'], App\Models\Utility::getValByName('decimal_number'), '.', '')}}%</h5>
                                    </div>
                                </div>
                                <div class="col-12 px-4">
                                    <div class="progress-wrapper pt-0">
                                        <div class="progress progress-xs mb-0 w-100">
                                            <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="{{number_format($goal->target($goal->type,$goal->from,$goal->to,$goal->amount)['percentage'], App\Models\Utility::getValByName('decimal_number'), '.', '')}}" aria-valuemin="0" aria-valuemax="100" style="width: {{number_format($goal->target($goal->type,$goal->from,$goal->to,$goal->amount)['percentage'],App\Models\Utility::getValByName('decimal_number'), '.', '')}}%;"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
