...
@endpush
@section('content')
<a href="#" class="btn btn-sm btn-primary btn-icon rounded-pill cp_link" data-link="{{route('pay.billpay',\Illuminate\Support\Facades\Crypt::encrypt($bill->id))}}" data-toggle="tooltip" data-original-title="{{__('Click to copy invoice link')}}">
