                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col text-md-center">
                                    <small>
                                        ...
                                        {{utility::dateFormat($company_setting,$bill->bill_date)}}<br><br>
                                    </small>
                                </div>
                                <div class="col text-md-right">
                                    <small>
                                        <strong>{{__('Due Date')}} :</strong><br>
                                        {{utility::dateFormat($company_setting,$bill->due_date)}}<br><br>
                                    </small>
                                </div>
                                <div class="col text-md-right">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            @foreach($iteams as $key =>$iteam)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">{{utility::priceFormat($company_setting,($iteam->price*$iteam->quantity))}}</td>
                                                </tr>
                                            @endforeach
                                            <tfoot>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">{{utility::priceFormat($company_setting,$bill->getSubTotal())}}</td>
                                            </tr>
                                            @if($bill->discount_apply==1)
                                                <tr>
                                                    <td colspan="5"></td>
                                                    <td class="text-right"><b>{{__('Discount')}}</b></td>
                                                    <td class="text-right">{{utility::priceFormat($company_setting,$bill->getTotalDiscount())}}</td>
                                                </tr>
                                            @endif
                                            @if(!empty($taxesData))
                                                @foreach($taxesData as $taxName => $taxPrice)
                                                    <tr>
                                                        ...
                                                        <td class="text-right">{{utility::priceFormat($company_setting,$taxPrice) }}</td>
                                                    </tr>
                                                @endforeach
                                            @endif
                                            <tr>
                                                ...
                                                <td class="blue-text text-right">{{utility::priceFormat($company_setting,$bill->getTotal())}}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="5"></td>
                                                <td class="text-right"><b>{{__('Paid')}}</b></td>
                                                <td class="text-right">{{utility::priceFormat($company_setting,($bill->getTotal()-$bill->getDue())-($bill->billTotalDebitNote()))}}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="5"></td>
                                                <td class="text-right"><b>{{__('Debit Note')}}</b></td>
                                                <td class="text-right">{{utility::priceFormat($company_setting,($bill->billTotalDebitNote()))}}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="5"></td>
                                                <td class="text-right"><b>{{__('Due')}}</b></td>
                                                <td class="text-right">{{utility::priceFormat($company_setting,$bill->getDue())}}</td>
                                            </tr>
                                            </tfoot>
                                        </table>
                                    </div>
